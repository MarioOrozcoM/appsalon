...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido = "<html>";
        $contenido .= "<p><strong>Hola " . $this->nombre . "<strong> Has creado tu cuenta en App Salon, solo debes confirmarla dando clic en el siguiente enlace</p>";
        $contenido .= "<p>Presiona aquí: <a href='" . $_ENV['APP_URL'] . "/confirmar-cuenta?token=". $this->token . "'>Confirmar cuenta</a> </p>";
        $contenido .= "<p>Si tu no solicitaste, puedes ignorar el mensaje</p>";
        $contenido .= "</html>";
